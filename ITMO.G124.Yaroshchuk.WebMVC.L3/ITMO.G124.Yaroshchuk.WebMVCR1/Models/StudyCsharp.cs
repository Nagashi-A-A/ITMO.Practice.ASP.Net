...
namespace ITMO.G124.Yaroshchuk.WebMVCR1.Models
{
    ...
    public class Triangle : Shape
    {
        ...
        //{ get { double p = Sta + Stb + Stc; return p; } }
        public double Area 
        { get 
    ...
    {
        override public string Name { get { return String.Format("\"Окружность с радиусом {0}\"", St); } }
        ...
        public class StudyCsharp
    {
        ...
        public static string GetFunction(double x1, double x2)
        {
            ...
            double x = x1; 
            do { str.AppendFormat("x = {0:0.##} : y = {1:0.##}; <br>", x, Math.Pow(x, 3)); x += 0.5; } 
            while (x <= x2);
            return str.ToString(); ;
        }
